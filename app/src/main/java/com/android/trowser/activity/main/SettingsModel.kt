...
import com.android.trowser.utils.UpdateChecker
import com.android.trowser.utils.observable.ObservableValue
import com.android.trowser.utils.sameDay
import com.android.trowser.utils.activemodel.ActiveModel
import com.android.trowser.utils.observable.makeObservable
...
class SettingsModel : ActiveModel() {
    ...
    val userAgentStringTitles = arrayOf("Trowser", "Chrome (Desktop)", "Chrome (Mobile)", "Chrome (Tablet)", "Firefox (Desktop)", "Firefox (Tablet)", "Edge (Desktop)", "Safari (Desktop)", "Safari (iPad)", "Apple TV", "Custom")
