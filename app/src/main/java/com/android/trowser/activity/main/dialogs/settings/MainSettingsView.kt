...
import com.android.trowser.activity.main.AdblockModel
import com.android.trowser.activity.main.SettingsModel
import com.android.trowser.databinding.ViewSettingsMainBinding
...
class MainSettingsView @JvmOverloads constructor(
    ...
    private fun initUAStringConfigUI(context: Context) {
        val selected = if (settingsModel.uaString.value == "" ||
                settingsModel.uaString.value.startsWith(SettingsModel.Trowser_UA_PREFIX)) {
            0
        } else {
