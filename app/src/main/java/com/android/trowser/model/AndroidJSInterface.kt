package com.android.trowser.model
...
import com.android.trowser.activity.main.MainActivityViewModel
import com.android.trowser.activity.main.TabsModel
import com.android.trowser.utils.DownloadUtils
    ...
    fun lastSSLError(getDetails: Boolean): String {
        return if (getDetails) {
            ...
            when (tabsModel.currentTab.value?.webView?.lastSSLError?.primaryError) {
                SslError.SSL_EXPIRED -> Trowser.instance.getString(R.string.ssl_expired)
                SslError.SSL_IDMISMATCH -> Trowser.instance.getString(R.string.ssl_idmismatch)
                SslError.SSL_DATE_INVALID -> Trowser.instance.getString(R.string.ssl_date_invalid)
                SslError.SSL_INVALID -> Trowser.instance.getString(R.string.ssl_invalid)
                else -> "unknown"
            }
        }
    }
