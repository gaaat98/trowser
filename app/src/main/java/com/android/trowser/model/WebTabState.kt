...
data class WebTabState(@PrimaryKey(autoGenerate = true)
    ...
    private fun getThumbnailPath(hash: String) =
        Trowser.instance.cacheDir.absolutePath + File.separator + TAB_THUMBNAILS_DIR + File.separator + hash + ".png"

    private fun getWVStatePath(hash: String) =
            Trowser.instance.filesDir.absolutePath + File.separator + TAB_WVSTATES_DIR + File.separator + hash
    ...
    fun saveWebViewStateToFile() {
        ...
        try {
            val statesDir = File(Trowser.instance.filesDir.absolutePath + File.separator + TAB_WVSTATES_DIR)
