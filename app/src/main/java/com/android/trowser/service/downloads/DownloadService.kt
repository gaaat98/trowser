package com.android.trowser.service.downloads
...
import com.android.trowser.model.DownloadIntent
import com.android.trowser.singleton.AppDatabase
import com.android.trowser.utils.activemodel.ActiveModelUser
...
class DownloadService : Service(), ActiveModelUser {
    ...
    private fun updateNotification(): Notification {
        ...
        if (notificationBuilder == null) {
            notificationBuilder = NotificationCompat.Builder(this, Trowser.CHANNEL_ID_DOWNLOADS)
                    .setOngoing(true)
